...
<form id="aluno" name="aluno" method="GET" target="_blank" action="relatorios/relDeclaracao.php?aluno=<?php echo $row_query_matricula['m_id_aluno']; ?> ">
   <select name="aluno" id="aluno">
    <?php
do {  
?>
    <option value="<?php echo $row_query_matricula['m_id_aluno']?>"<?php if (!(strcmp($row_query_matricula['m_id_aluno'], $row_query_matricula['a_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_query_matricula['a_nome']?></option>
    <?php
